...
const SprintBoard = ({ sprints, projectId, organizationId }) => {
  ...
  const handleAddIssue = (status) => {
    if (currentSprint.status !== "ACTIVE") {
      return toast.warning("Start the sprint to create issues in it");
    }
  ...
  if (issesError) return <div>Error Loading Issues</div>;
  ...
  return (
    <div className="flex flex-col">
      ...
      {updateIssesError && (
        <p className="text-red-500 mt-2">{updateIssesError.message}</p>
      )}
